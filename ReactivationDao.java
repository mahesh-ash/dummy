...
// const fields = INVOICE_IMAGE_VARIABLE.value.formConfig?.formFields || []; // original values of config
        ...
        formFields: [
            {
                ...
                type: 'async-typeahead', // or "async-typeahead"
                mandatory: true,
                disabled: false,
                hidden: false,
                readOnly: false,
...
const fieldConfigs = fields.reduce((acc, field, idx) => {
    acc[field.name] = {
        ...
        fileFormat: field.fileFormat || null,
    ...
    return (
        <div className="w-full">
            ...
            <Sheet open={sheetOpen} onOpenChange={handleSheetOpenChange}>
                <SheetContent className="sm:max-w-[95vw] lg:max-w-[1400px] h-[90vh] ">
                    <SheetHeader>
                    ...
                    <div className="flex-1 overflow-y-auto overflow-x-hidden pr-2">
                        <Form autocomplete="off" {...form}>
                            <form autoComplete="off" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-4 sm:gap-x-6 p-2 sm:p-4 invoice-form">
                                {mainFields
                                    .filter((fieldName) => !['attach', 'comments'].includes(fieldName))
                                    .map((fieldName) => {
